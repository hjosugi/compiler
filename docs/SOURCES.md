...
GitHub上の件数とrelease statusは公開REST APIを同日取得し、query、UTC取得時刻、主要fieldを[`data/snapshot-manifest.json`](../data/snapshot-manifest.json)に保存しています。
...
- [Swift SIL](https://github.com/swiftlang/swift/blob/main/docs/SIL/SIL.md)
...
## Kofun architecture一次資料

- [Kofun compiler architecture snapshot](https://github.com/kofun-lang/kofun/blob/075fbb241367c27863c74f3884989ba7ddbbfa5b/docs/COMPILER_ARCHITECTURE.md)
- [RFC-0018 self-contained native toolchain snapshot](https://github.com/kofun-lang/kofun/blob/075fbb241367c27863c74f3884989ba7ddbbfa5b/rfcs/0018-self-contained-native-toolchain.md)
- [Kofun 1.0 tracker #1119](https://github.com/kofun-lang/kofun/issues/1119)
- [Generics lowering modes #1276](https://github.com/kofun-lang/kofun/issues/1276)
- [Generics measurement #1277](https://github.com/kofun-lang/kofun/issues/1277)
- [Common Decimal numeric IR #1402](https://github.com/kofun-lang/kofun/issues/1402)
